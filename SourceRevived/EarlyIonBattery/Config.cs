...
namespace Ramune.EarlyIonBattery
{
    ...
    public class Config : ConfigFile
    {
        ...
        [Choice("Ion power cell unlocks with:", ["<color=#ffcf3c><b>1/3 </b></color> QEP Data Terminal", "<color=#ffcf3c><b>2/3 </b></color> Disease Research Facility", "<color=#ffcf3c><b>3/3 </b></color> Lost River Cache Terminal"], Order = 2)]
        public int IonPowerCellUnlocksWith = 0;

        [Button("Force <color=#9ae86e>learn</color> Ion battery & power cell", Tooltip = "Click to learn the Ion battery & power cell blueprints", Order = 3)]
        ...
        [Button("Force <color=#ff4200>un-learn</color> Ion battery & power cell", Tooltip = "Click to un-learn the Ion battery & power cell blueprints", Order = 4)]
