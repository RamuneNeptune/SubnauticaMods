...
namespace Ramune.RamunesWorkbench
{
    public static class CraftHandler
    {
        ...
        public static void AddCraft(string techType)
        {
            ...
            CraftTreeHandler.AddCraftingNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, _techType);
        }


        public static void AddCraft(TechType techType) => CraftTreeHandler.AddCraftingNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, techType);
        ...
        public static void AddCraft(string techType, params string[] stepsToTab)
        {
            ...
            CraftTreeHandler.AddCraftingNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, _techType, stepsToTab);
        }


        public static void AddCraft(TechType techType, params string[] stepsToTab) => CraftTreeHandler.AddCraftingNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, techType, stepsToTab);


        public static void AddTab(string name, Sprite sprite) => CraftTreeHandler.AddTabNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, name, name, sprite);


        public static void AddTab(string name, TechType techType) => CraftTreeHandler.AddTabNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, name, name, ImageUtils.GetSprite(techType));


        public static void AddTab(string name, Sprite sprite, params string[] stepsToTab) => CraftTreeHandler.AddTabNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, name, name, sprite, stepsToTab);


        public static void AddTab(string name, TechType techType, params string[] stepsToTab) => CraftTreeHandler.AddTabNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, name, name, ImageUtils.GetSprite(techType), stepsToTab);


        public static void AddTab(string id, string name, Sprite sprite, params string[] stepsToTab) => CraftTreeHandler.AddTabNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, id, name, sprite, stepsToTab);


        public static void AddTab(string id, string name, TechType techType, params string[] stepsToTab) => CraftTreeHandler.AddTabNode(Prefabs.Buildables.RamunesWorkbench.craftTreeType, id, name, ImageUtils.GetSprite(techType), stepsToTab);
    }
}
