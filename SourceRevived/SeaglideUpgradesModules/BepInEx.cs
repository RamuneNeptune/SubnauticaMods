...
namespace Ramune.SeaglideUpgradesModules
{
    ...
    public class SeaglideUpgradesModules : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            Prefabs.UpgradeModules.BatterySwapUpgrade.Register();
            Prefabs.UpgradeModules.BoostUpgrade.Register();
            Prefabs.UpgradeModules.EfficiencyUpgrade.Register();
            Prefabs.UpgradeModules.LightUpgrade.Register();
            Prefabs.UpgradeModules.NoiseDampeningUpgrade.Register();
            Prefabs.UpgradeModules.PowerglideUpgrade.Register();
            Prefabs.UpgradeModules.SpeedUpgrade.Register();
