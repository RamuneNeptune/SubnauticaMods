...
{
    [Menu("RamunesFasterScanning")]
    public class Config : ConfigFile
    {
        [Toggle("<color=#ffc600>Configuration:</color> <alpha=#00>------------------------------------------------------------------------------------------------------------</alpha>")]
        public bool DividerCfg = false;

        [Slider("• Scanning speed multiplier", Format = "{0:F1}x", DefaultValue = 1f, Min = 0.1f, Max = 5f, Step = 0.1f)]
        public float Multiplier = 1f;

        [Slider("• Scanning speed multiplier (mega)", Format = "{0:F1}x", DefaultValue = 5f, Min = 5f, Max = 20f, Step = 0.1f)]
