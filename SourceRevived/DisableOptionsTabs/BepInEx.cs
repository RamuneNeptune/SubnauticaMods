...
namespace Ramune.DisableOptionsTabs
{
    ...
    public class DisableOptionsTabs : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            if(!this.Initialize(harmony, Logger, Name, Version, config.EnableThisMod, "https://raw.githubusercontent.com/RamuneNeptune/SubnauticaMods/refs/heads/main/SourceRevived/DisableOptionsTabs/Version.json"))
                return;
        }
    }
}