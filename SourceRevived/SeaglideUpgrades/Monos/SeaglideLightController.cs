...
namespace Ramune.SeaglideUpgrades.Monos
{
    ...
    public class SeaglideLightController : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            switch(techType)
            {
                case var x when x == Prefabs.Deployables.SeaglideMK1.Prefab.Info.TechType:
                    Config.OnChangeMK1();
                    break;

                case var x when x == Prefabs.Deployables.SeaglideMK2.Prefab.Info.TechType:
                    Config.OnChangeMK2();
                    break;

                case var x when x == Prefabs.Deployables.SeaglideMK3.Prefab.Info.TechType:
                    Config.OnChangeMK3();
                    break;
            }
        }
