...
namespace Ramune.SeaglideUpgrades.Patches
{
    ...
    public static class PlayerToolPatch
    {
        public static Dictionary<TechType, Action<float>> ModdedSeaglideTechTypes = new()
        {
            ...
            { 
                Prefabs.Deployables.SeaglideMK1.Prefab.Info.TechType, (multiplier) => SeaglideUpgrades.SetSeaglideSpeed(42f, 42f, SeaglideUpgrades.config.speedmk1 * multiplier) 
            },
            { 
                Prefabs.Deployables.SeaglideMK2.Prefab.Info.TechType, (multiplier) => SeaglideUpgrades.SetSeaglideSpeed(50f, 50f, SeaglideUpgrades.config.speedmk2 * multiplier) 
            },
            { 
                Prefabs.Deployables.SeaglideMK3.Prefab.Info.TechType, (multiplier) => SeaglideUpgrades.SetSeaglideSpeed(58f, 58f, SeaglideUpgrades.config.speedmk3 * multiplier) 
            }
        };
