...
namespace Ramune.SeaglideUpgrades
{
    ...
    public class Config : ConfigFile
    {
        ...
        {
            var techType = Prefabs.Deployables.SeaglideMK1.Prefab.Info.TechType;
        ...
        {
            var techType = Prefabs.Deployables.SeaglideMK2.Prefab.Info.TechType;
        ...
        {
            var techType = Prefabs.Deployables.SeaglideMK3.Prefab.Info.TechType;
        ...
        public static void OnChangeMK1() => Monos.SeaglideLightControllerManager.Apply(Prefabs.Deployables.SeaglideMK1.Prefab.Info.TechType, new Color(SeaglideUpgrades.config.redmk1, SeaglideUpgrades.config.greenmk1, SeaglideUpgrades.config.bluemk1), SeaglideUpgrades.config.rangemk1, SeaglideUpgrades.config.intensitymk1, SeaglideUpgrades.config.conesizemk1);


        public static void OnChangeMK2() => Monos.SeaglideLightControllerManager.Apply(Prefabs.Deployables.SeaglideMK2.Prefab.Info.TechType, new Color(SeaglideUpgrades.config.redmk2, SeaglideUpgrades.config.greenmk2, SeaglideUpgrades.config.bluemk2), SeaglideUpgrades.config.rangemk2, SeaglideUpgrades.config.intensitymk2, SeaglideUpgrades.config.conesizemk2);


        public static void OnChangeMK3() => Monos.SeaglideLightControllerManager.Apply(Prefabs.Deployables.SeaglideMK3.Prefab.Info.TechType, new Color(SeaglideUpgrades.config.redmk3, SeaglideUpgrades.config.greenmk3, SeaglideUpgrades.config.bluemk3), SeaglideUpgrades.config.rangemk3, SeaglideUpgrades.config.intensitymk3, SeaglideUpgrades.config.conesizemk3);
