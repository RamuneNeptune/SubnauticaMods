...
namespace Ramune.TableCoralMultiplier
{
    ...
    public class TableCoralMultiplier : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            if(!Initializer.Initialize(harmony, Logger, Name, Version, config.EnableThisMod, "https://raw.githubusercontent.com/RamuneNeptune/SubnauticaMods/refs/heads/main/Source/TableCoralMultiplier/Version.json"))
                return;
        }
    }
}