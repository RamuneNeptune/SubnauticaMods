...
namespace Ramune.NoPassiveScannerRoomPowerDrain
{
    ...
    public class NoPassiveScannerRoomPowerDrain : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            if(!this.Initialize(harmony, Logger, Name, Version, config.EnableThisMod, "https://raw.githubusercontent.com/RamuneNeptune/SubnauticaMods/refs/heads/main/Source/NoPassiveScannerRoomPowerDrain/Version.json"))
                return;
        }
    }
}