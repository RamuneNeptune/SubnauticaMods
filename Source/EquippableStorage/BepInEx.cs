...
namespace Ramune.EquippableStorage
{
    ...
    public class EquippableStorage : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            if(!Initializer.Initialize(harmony, Logger, Name, Version, config.EnableThisMod, "https://raw.githubusercontent.com/RamuneNeptune/SubnauticaMods/refs/heads/main/Source/EquippableStorage/Version.json"))
                return;
