...
namespace RamuneLib.Extensions
{
    internal static class StringExtensions
    {
        ...
        /// </summary>
        /// <returns></returns>
        internal static bool IsValidURL(this string source) => new Uri(source) is var uri && uri.IsAbsoluteUri && (uri.Scheme == Uri.UriSchemeHttp || uri.Scheme == Uri.UriSchemeHttps);
