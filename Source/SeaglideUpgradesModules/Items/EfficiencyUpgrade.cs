...
namespace Ramune.SeaglideUpgradesModules.Items
{
    ...
    {
        public static CustomPrefab Prefab = PrefabUtils.CreatePrefab("SeaglideEfficiencyUpgrade", "ramune.sgum.efficiencyupgrade.name".LangKey(), "ramune.sgum.efficiencyupgrade.desc".LangKey(), ImageUtils.GetSprite("EfficiencyUpgrade", TechType.PowerUpgradeModule))
