...
namespace Ramune.EnableAchievements
{
    ...
    public class EnableAchievements : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            if(!Initializer.Initialize(harmony, Logger, Name, Version, config.EnableThisMod, "https://raw.githubusercontent.com/RamuneNeptune/SubnauticaMods/refs/heads/main/Source/EnableAchievements/Version.json"))
                return;
