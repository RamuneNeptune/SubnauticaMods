...
namespace Ramune.NoEpilepsyWarning
{
    ...
    public class NoEpilepsyWarning : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            if(!this.Initialize(harmony, Logger, Name, Version, config.EnableThisMod, "https://raw.githubusercontent.com/RamuneNeptune/SubnauticaMods/refs/heads/main/Source/NoEpilepsyWarning/Version.json"))
                return;
        }
    }
}