...
namespace Ramune.FasterCrafting
{
    ...
    public class FasterCrafting : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            if(!Initializer.Initialize(harmony, Logger, Name, Version, config.EnableThisMod, "https://raw.githubusercontent.com/RamuneNeptune/SubnauticaMods/refs/heads/main/Source/FasterCrafting/Version.json"))
                return;
        }
    }
}