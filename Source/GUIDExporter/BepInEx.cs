...
namespace Ramune.GUIDExporter
{
    ...
    public class GUIDExporter : BaseUnityPlugin
    {
        ...
        public static IEnumerator WaitForChainloader()
        {
            ...
            File.WriteAllText(Path.Combine(Paths.PluginFolder, "GUIDs.json"), JsonConvert.SerializeObject(Chainloader.PluginInfos.Keys.ToDictionary(x => x, x => ""), Formatting.Indented));
        }
    }
}